    ...
    <div style={{textAlign:i18n.language === "ar"? "right":"left"}}>
      <div className="div-bg">
        ...
        <div className="bg-light p-3 border rounded-2">
          <div className="row">
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 col-12">
              <div className="my-3">
                <b className="d-block text-sm">{t("labels.managementName")}</b>
              ...
              <div className="my-3">
                <b className="d-block text-sm">{t("labels.employee_number")}</b>
                <span className="text-sm">
              ...
              <div className="my-3">
                <b className="d-block text-sm">{t("labels.employmentDate")}</b>
                <span className="text-sm">
      ...
      <div className="bg-light p-3 border rounded-2">
        <div className="row">
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
            <div className="my-3">
              <b className="text-sm"><i className="bi bi-menu-up main-color"></i>{" "}{t("labels.company_source")}</b>
          ...
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
            <div className="my-3">
              <b className="text-sm"><i className="bi bi-menu-up main-color"></i>{" "}{t("labels.general_supervisor")}</b>
          ...
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
            <div className="my-3">
              <b className="text-sm"><i className="bi bi-menu-up main-color"></i>{" "}{t("labels.operations_supervisor")}</b>
        ...
        <div className="row">
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
            ...
            {record?.apps_access?.company_application == false ? (
              ...
              <span className="highlight-green text-sm mx-3">{t("labels.active")}</span>
            )}
          </div>
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
            <b className="text-sm d-block my-2">
        ...
        <div className="row">
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
            ...
            {record?.customize_users?.company_control === "all" ? (
              <span className="text-color text-sm mx-3">{t("labels.all")}</span>
          ...
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
            ...
            {record?.customize_users?.winch_branch_control === "all" ? (
              <span className="text-color text-sm mx-3">{t("labels.all")}</span>
            ) : record?.customize_users?.winch_branch_control === "include" ? (
              <span className="text-color text-sm mx-3">
                {t("labels.include")}
              </span>
            ) : (
          ...
          <div className="col-xl-4 col-lg-4 col-md-6 col-12">
            ...
            {record?.customize_users?.individual_customer_control === "show" ? (
              <span className="text-color text-sm mx-3">
                {t("labels.show")}
              </span>
            ) : (
          ...
          <div className="col-xl-6 col-lg-6 col-md-6 col-12">
              <b className="d-block text-sm"><i className="bi bi-briefcase main-color"></i>{" "}{t("labels.business_sector")}</b>
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 col-12">
              <b className="d-block text-sm"><i className="bi bi-ui-checks-grid main-color"></i>{" "}{t("labels.wensh_branch")}</b>
