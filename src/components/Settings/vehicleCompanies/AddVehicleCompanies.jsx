...
import { addVehicleCompanies, clearState } from "../../../redux/Slices/VehicleCompaniesSlice";
import { useDispatch, useSelector } from "react-redux";
import { useNavigate } from "react-router-dom";
import { toast } from "react-toastify";
const AddVehicleCompanies = () => {
  ...
  useEffect(() => {
    setTitle(`${t('sidenav.vehicleCompanies')} > ${t('btns.add')}`);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    dispatch(clearState());
    dispatch(addVehicleCompanies(formData));
    setFormData({
      name_ar: "",
      name_en: ""
    });
...
export default AddVehicleCompanies;
