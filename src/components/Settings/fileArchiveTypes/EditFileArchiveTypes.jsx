      ...
      <form onSubmit={handleSubmit} className="table_form form-style my-3 py-3 div-bg">
        <div className="row align-items-center">
          <div className="col-xl-6 col-lg-6 col-md-12 col-12">
            ...
            <input type="text" className="input-bg" value={formData.name_ar} required name="name_ar" onChange={handleChange} />
          </div>
          <div className="col-xl-6 col-lg-6 col-md-12 col-12">
            <label className="text-light"> {t('labels.nameEnglish')} </label>
            <input type="text" className="input-bg" value={formData.name_en} required name="name_en" onChange={handleChange} />
          </div>

          <div className="col-xl-12 col-lg-12 col-md-12 col-12 text-center">
            <button type="submit" className="btn px-4 save">{t('btns.add')}</button>
          </div>
        </div>
      </form>
    </>
