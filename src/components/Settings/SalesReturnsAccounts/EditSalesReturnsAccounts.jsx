...
const EditSalesReturnsAccounts = () => {
  const { id } = useParams();
  ...
  useEffect(() => {
    setTitle(t("sidenav.edit_sales_returns_accounts"));
    document.title = t("sidenav.edit_sales_returns_accounts");
    return () => {
  ...
  useEffect(() => {
    dispatch(SalesReturnsAccountsRecord(id));
  }, [dispatch, id]);
...
export default EditSalesReturnsAccounts;
