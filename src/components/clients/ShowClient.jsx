      ...
      <div className="div-bg">
        ...
        <div className="bg-light p-3 border rounded-2">
          <div className="row">
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 col-12">
              <div className="my-3">
                <b className="d-block text-sm mb-2">{t("labels.clientID")}:</b>
                <span className="d-block text-sm">
                  <i className="bi bi-person main-color"></i>{" "}
        ...
        <div className="bg-light p-3 border rounded-2">
          <div className="row">
            <div className="col-xl-12 col-lg-12 col-md-12 col-12">
              <div className="my-3">
                <b className="d-block text-sm">{t("sidenav.bankAccounts")}: </b>
                <span className="d-block text-sm">
        ...
        <div className="bg-light p-3 border rounded-2">
          <div className="row">
            <div className="col-xl-12 col-lg-12 col-md-12 col-12">
              <div className="my-3">
                <b className="d-block text-sm">{t("labels.account_tree")}: </b>
                <span className="d-block text-sm">
        ...
        <div className="bg-light p-3 border rounded-2">
          <div className="row">
            <div className="col-xl-6 col-lg-6 col-md-6 col-12">
              ...
              <div className="my-3">
                <b className="d-block text-sm">{t("labels.draft_balance")}:</b>
                <span className="d-block text-sm">
              ...
              <div className="my-3">
                <b className="d-block text-sm">{t("labels.payment_method")}:</b>
                <span className="d-block text-sm">
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 col-12">
              <div className="my-3">
                <b className="d-block text-sm">{t("labels.total_balance")}:</b>
                <span className="d-block text-sm">
              ...
              <div className="my-3">
                <b className="d-block text-sm">{t("labels.total_revenue")}:</b>
                <span className="d-block text-sm">
        ...
        <div className="bg-light p-3 border rounded-2">
          <div className="row">
            <div className="col-xl-6 col-lg-6 col-md-6 col-12">
              ...
              <div className="my-3">
                ...
                <span className="d-block text-sm">
                  ...
                  {record?.rental_trip_orders?.order_changed_by_provider || "0"}
                </span>
              </div>
            </div>
            ...
            <div className="col-xl-6 col-lg-6 col-md-6 col-12">
              <div className="my-3">
                <b className="d-block text-sm">{t("labels.rental_orders")}:</b>
                <span className="d-block text-sm">
